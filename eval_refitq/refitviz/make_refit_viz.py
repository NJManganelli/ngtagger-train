...
_DEFAULT_NANO = "/Users/nmangane/smartpixels/cmssw/work/spxsmoke/nano/nano_puD_TrkSmartPix_withGen.root"
...
def main():
    ...
    ap.add_argument("--tracks", nargs="*", default=None, metavar="EVENT:IDX",
                    help="force-select tracks (e.g. 0:28 0:11); else auto-curate clean/wrong/fake")
    ...
    res = build_refit_viz(args.nano, tracks=tracks, out_html=args.out,
                          n_each=(args.n_clean, args.n_wrong, args.n_fake),
